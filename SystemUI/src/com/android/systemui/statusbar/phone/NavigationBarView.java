...
public class NavigationBarView extends LinearLayout {
    ...
    public KeyButtonView getMenuButton() {
        return (KeyButtonView)mCurrentView.findViewById(R.id.menu);
    }

    public KeyButtonView getBackButton() {
        return (KeyButtonView)mCurrentView.findViewById(R.id.back);
    }
    ...
    public KeyButtonView getSearchButton() {
        return (KeyButtonView)mCurrentView.findViewById(R.id.search);
    }
    ...
    public void setButtonColor(){
        getBackButton().setButtonColor();
        getHomeButton().setButtonColor();
        getRecentsButton().setButtonColor();
        if(getSearchButton() != null)
            getSearchButton().setButtonColor();
        getMenuButton().setButtonColor();
    }
