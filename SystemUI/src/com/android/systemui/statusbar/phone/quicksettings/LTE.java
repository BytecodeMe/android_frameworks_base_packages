...
public class LTE extends StatusBarPreference
    ...
    public LTE(Context context, View view) {
        super(context, view);
    ...
    public void init() {
        ...
        mCheckBox.setChecked(mLTEmode);
        mCheckBox.setOnCheckedChangeListener(this);
        
        mTitle.setText(R.string.status_bar_settings_lte);
        mIcon.setImageResource(R.drawable.ic_sysbar_lte_on);
    ...
    //updates the preference based on network and phone info
        ...
        mCheckBox.setEnabled(!isWifiConnected && mPhoneState == TelephonyManager.CALL_STATE_IDLE);
        
        if(mTelephonyManager.getNetworkType()==TelephonyManager.NETWORK_TYPE_UNKNOWN){
            mTitle.setText(R.string.status_bar_settings_disabled);
            mContentView.setEnabled(false);
            mCheckBox.setEnabled(false);
        }else{
            mTitle.setText(mTelephonyManager.getNetworkTypeName());
