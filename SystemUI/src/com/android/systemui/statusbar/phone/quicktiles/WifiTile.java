...
public class WifiTile extends QuickSettingsTileContent 
	implements NetworkSignalChangedCallback, View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(View v) {
		mWifiManager.setWifiEnabled(!mWifiState.enabled);
    }

	@Override
	public boolean onLongClick(View v) {
		launchActivity(new Intent(android.provider.Settings.ACTION_WIFI_SETTINGS));
		return true;
	}
	
	private void updateGUI(State state) {
		WifiState wifiState = (WifiState) state;
        mTextView.setCompoundDrawablesWithIntrinsicBounds(0, wifiState.iconId, 0, 0);
